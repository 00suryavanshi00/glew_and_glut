...
glColor3f(1,0.75,0);
output(150,600,"DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING",5);
glColor3f(0,0,1);
output(300,500,"A MINI PROJECT ON",2);
glColor3f(0.5,0.4,0.1);
output(300,450,"OSI Transmission Mode",2);
glColor3f(1,0,0);
output(350,350,"By:",2);
glColor3f(0,0.75,1);
output(150,300,"YOUR NAME         (YOUR USN) ",5);
output(450,300,"YOUR PARTNER NAME    (YOUR USN) ",5);
glColor3f(1,0,0);
output(350,250,"Guides:",2);
glColor3f(0,0.75,1);
output(150,200,"Guide 1 (Qulification) ",2);
output(450,200,"Guide 2 (Qulification) ",2);
glColor3f(1,1,1);
